...
function updateSetupStartButton() {
    ...
    el.heroNameInput.classList.toggle("setup-name-input--error", setupHintForced && blockers.includes("enter your name"));
...
function playHeroDance(foeJoins) {
