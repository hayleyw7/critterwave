...
const el = {
    ...
    goblinImage: document.getElementById("goblin-image"),
...
function persist(snapshot) {
    const save = loadSave();
    const activeSnapshot = phase === "gameover" ? undefined : (snapshot ?? getSnapshot());
...
async function withActionLock(fn) {
    if (actionsLocked || phase === "gameover")
        return;
    actionsLocked = true;
    render();
    try {
